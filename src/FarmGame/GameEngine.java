...
public class GameEngine {
	...
	public GameEngine() {
		...
		levels.add(2, new Level( "Sheep", "BackgroundImages/SheepMap.jpg", 5, AnimalType.SHEEP, "AnimalImages/Sheep.png"));
		levels.add(2, new Level( "Pig", "BackgroundImages/PigMap.jpg", 6, AnimalType.PIG, "AnimalImages/Pig.png"));
		levels.add(3, new Level( "Cow", "BackgroundImages/CowMap.jpg", 7, AnimalType.COW, "AnimalImages/Cow.png"));
